...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-43510a5b.js", "src/routes/index.svelte": "pages/index.svelte-e4641110.js"};
const manifest = {
  ...
  routes: [
    {
      ...
      css: ["assets/start-d4cd1237.css", "assets/pages/index.svelte-eaf6aaca.css"],
      js: ["start-43510a5b.js", "chunks/vendor-8009c737.js", "pages/index.svelte-e4641110.js"]
    }
  ]
};
...
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="${"svelte-ocp1vb"}"><h1 class="${"svelte-ocp1vb"}">Hello Svelte.kit!</h1>
